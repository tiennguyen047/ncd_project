...
logger = logging
log_filename = '{}/log_controler/app.log'.format(get_git_root(__file__))
...
latest_indices_file_json = "{}/latest_indices.json".format(
...
def fpt():
    ...
    save_data_frame_to_csv(price_board(Tech.FPT), os.path.join(
